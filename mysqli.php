...
define("DB_SERVER", "tunnitooaj.mariadb.database.azure.com");
define("DB_USER", "allanj@tunnitooaj");
define("DB_PASS", "S1tav1kat"); // Siia parool :)
define("DB_NAME", "homeworkaj"); //andmebaasi nimi
